    ...
    <div class="wrapper">
        <div class="cnt" style="padding-top: 15px;">
            <table width="100%" cellspacing="0" cellpadding="10" border="0" style="border-collapse: collapse; border: 1px solid #000;">
                <tr>
                    <td colspan="2">
                        <form action="<?= base_url()?>admin/editarRespuestaMision" method="post" accept-charset="utf-8">
                            ...
                            <div class="formRow" style="overflow: hidden;">
                                ...
                                <?php
                                    foreach ($respuesta as $row_respuesta){?>
                                        <div class="grid9"><input type="text" name="respuesta" required="required" value="<?= $row_respuesta->RespuestaMision?>"><input type="hidden" name="id" value="<?= $row_respuesta->IdRespuestaMision?>"></div>
                                    <?php }
                                ?>
