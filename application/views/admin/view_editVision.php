    ...
    <div class="wrapper">
        <div class="cnt" style="padding-top: 15px;">
            <table width="100%" cellspacing="0" cellpadding="10" border="0" style="border-collapse: collapse; border: 1px solid #000;">
                <tr>
                    <td colspan="2">
                        <form action="<?= base_url()?>admin/editVision" method="post" accept-charset="utf-8">
                            <div class="widget fluid">
                            <div class="whead"><h6>Editar Visión</h6><div class="clear"></div></div>
                            <div class="formRow" style="overflow: hidden;">
                                <div class="grid3"><label>Visión : </label></div>
                                <?php
                                    foreach ($vision as $row_respuesta){?>
                                        <div class="grid9"><input type="text" name="respuesta" required="required" value="<?= $row_respuesta->Vision?>"><input type="hidden" name="id" value="<?= $row_respuesta->IdVision?>"></div>
                                    <?php }
                                ?>
                            ...
                            <div class="formRow" >
                                    <div class="grid9" align="right" style="width: 100%"><input type="submit" class="buttonS bGreen" value="Modificar Visión"/></div>
                                    <div class="clear"></div>
                            </div>
                            </div>
                        </form>
